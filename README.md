...
+- 60% do tempo (100 ms) corresponde ao algoritmo de compactação dos rectangulos (mas depois de testes verifiquei que se não compactar os tempos totais são maiores).
